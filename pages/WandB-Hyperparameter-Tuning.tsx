...
export default function WandBHyperparameterTuning() {
  const fadeIn = {
    hidden: { opacity: 0 },
  ...
  return (
    <ChakraProvider>
      <Helmet>
        <title>WandB Hyperparameter Tuning | Jacob Leone</title>
        <meta name="description" content="Learn about hyperparameter tuning using WandB." />
        <meta name="keywords" content="WandB, Hyperparameter Tuning, Machine Learning, Deep Learning" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="WandB Hyperparameter Tuning | Jacob Leone" />
        <meta property="og:description" content="Learn about hyperparameter tuning using WandB." />
        <meta property="og:url" content="https://jacobleone.tech/WandB-Hyperparameter-Tuning" />
        <link rel="canonical" href="https://jacobleone.tech/WandB-Hyperparameter-Tuning" />
      </Helmet>
      <Flex
        direction="column"
        minHeight="100vh"
        ...
        >
          ...
          >
            <Text textAlign={'center'} pb="40px">
              In this lesson, we will learn how to use WandB to systematically tune hyperparameters.
            </Text>
