  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text color="white" textAlign="center" mb={1}>I am intrinsically motivated when it comes to my eagerness to solve both creative and tecnical problems on an team of agile developers in order to work towards a common goal of achieving the greatest value to clients with efficiency. Prior to my debut in the world of tech, I studied at a prestigious university under a rigorous graduate program researching artificial intelligence and psyhcology in an academic environment which I believe gave me a unique ability to see AI development with a human-first perspective and the ability to understand how humans interface with technology in a mentally intuitive way. I am also an avid learner with experience in leadership, creativity, problem solving, and building projects from ideation to execution.</Text>
